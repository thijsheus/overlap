...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 10:41:14 2019
...
for file1 in Cfilenames0:
    ...
    if m0==0:
        plt.savefig('rico82800_factor_average1_061919.eps', dpi=300,bbox_inches='tight')
        
    elif m0==1:
        plt.savefig('rico201600_factor_average1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0==2:
        plt.savefig('arm28800_factor_average1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0==3:
        plt.savefig('arm41400_factor_average1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0 ==4:
        plt.savefig('bomexAll_factor_average1_061919.eps', dpi=300,bbox_inches='tight')
    ...
    """
    if m0==0:
        plt.savefig('rico82800_factor_average1_emp1_061919.eps', dpi=300,bbox_inches='tight')
        
    elif m0==1:
        plt.savefig('rico201600_factor_average1_emp1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0==2:
        plt.savefig('arm28800_factor_average1_emp1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0==3:
        plt.savefig('arm41400_factor_average1_emp1_061919.eps', dpi=300,bbox_inches='tight')
        
        
    elif m0 ==4:
        plt.savefig('bomexAll_factor_average1_emp1_061919.eps', dpi=300,bbox_inches='tight')
